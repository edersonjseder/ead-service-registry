...
@EnableAsync
@EnableScheduling
@EntityScan(basePackages = "com.ead.serviceregistry")
@ComponentScan(basePackages = {"com.ead.serviceregistry.*"})
@EnableJpaRepositories(basePackages = {"com.ead.serviceregistry.repositories"})
